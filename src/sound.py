...
class SoundManager:
    def __init__(self):
        ...
        self.discard_effect_sound = pygame.mixer.Sound('res/sound/discard1.wav')
        self.draw_effect_sound = pygame.mixer.Sound('res/sound/draw1.wav')
        ...
        self.click_effect_sound = pygame.mixer.Sound('res/sound/click.mp3')
