...
initial_settings = {"achieved": [False, False, False, False, False, False, False, False],
                    ...
                    "text": ["A: 싱글 플레이어 대전에서 승리", "B: 스토리 모드 클리어", "C: 싱글 게임에서 10턴 안에 승리", "D: 기술 카드 사용하지 않고 승리", "E: 다른 플레이어가 UNO 선언한 뒤 승리", "F: 모든 턴에서 5초 안에 카드 골라 승리", "G: 연속 3번 같은 숫자 내기", "H: 한가지 색 카드 모두 모으기"]}
